...
<h5 class="p-3 mb-2 bg-primary text-white" style="text-align:center;" >투표 상세 페이지</h5>
<ul>
...
<c:choose>
	<c:when test="${complete=='n' }">
		<button type="button" class="btn btn-primary btn-sm" onclick="MovePage(${no})">투표하기</button>
	</c:when>
	<c:otherwise>
		투표완료	
	</c:otherwise>
