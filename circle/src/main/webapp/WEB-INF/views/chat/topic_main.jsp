...
<div id="wrapper">
            ...
            <div class="menu-top">
                <ul class="menu-bar">
                    <li class="gnb-btn nav-item dropdown no-arrow mx-1">
                        <a class="fa fa-bars nav-link dropdown-toggle" id="alertsDropdown" role="button"
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center"
                               href="${pageContext.request.contextPath}/team_admin/team_manager_team">
            ...
            <div class="menu-bottom">
                <ul class="menu-bar">
                    ...
                    <li class="gnb-btn hdd">
                        <a class="fa fa-hdd"
                           href="${pageContext.request.contextPath}/drive/drive?team_no=${param.team_no}&member_no=${sessionScope.member_no}"></a>
                    </li>
                </ul>
            </div>
            <!-- 투표 기능 시작 -->
                        ...
                        <ul>
                            <c:forEach var="voteList" items="${voteList }">
                                <fmt:formatNumber type="number"
                                                  var="no">${voteList.vote_create_team_no}</fmt:formatNumber>
                                <li>
                                    <c:if test="${param.team_no == no}">
                                        <c:out value="${voteList.vote_create_no}"/>번 투표
                                        <input type="button" name="${voteList.vote_create_no }"
        ...
        <div class="sidebar-brand d-flex align-items-center justify-content-center">
            <div class="logowrap">
                <div class="sidebar-brand-icon logo-back">
                    <img style="width:44px" src="${pageContext.request.contextPath}/resources/image/logo.png"
                         alt="logo"/>
                </div>
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <c:forEach items="${topicList}" var="topicListDto" varStatus="status">
                        <a class="collapse-item"
                           href="${pageContext.request.contextPath}/chat/topic_main?team_no=${param.team_no}&topic_no=${topicListDto.topic_no}">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
                            ...
                            <c:choose>
                                <c:when test="${tmList.topic_member_position eq '토픽소유자' }">
                                    ...
                                    <c:if test="${topicList.size() > 1}">
                                        <a class="dropdown-item d-flex align-items-center"
                                           href="deletetopic?topic_no=${param.topic_no }&team_no=${param.team_no}">
                                            <div>
                                ...
                                <c:otherwise>
                                    ...
                                    <a class="dropdown-item d-flex align-items-center"
                                       href="outtopic?topic_no=${param.topic_no }&member_no=${sessionScope.member_no}">
                                        <div>
                                            <div class="text-truncate">토픽 나가기</div>
                                        </div>
                                    </a>
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src='${pageContext.request.contextPath}/member/download?member_no=${member_no}'>
                        </a>
                            ...
                            <article class="message-wrap">
                                                                ...
                                                                <div class="card-body admin-card-body">
                                                                    <c:choose>
                                                                        <c:when test="${fn:startsWith(chatVo.chat_file_type,'text')}">
                                                                            <div><img id="chat_dummy"
                                                                                      src="${pageContext.request.contextPath}/resources/image/textdummy.jpeg">
                                                                            </div>
                                                                        </c:when>
                                                                        <c:when test="${fn:startsWith(chatVo.chat_file_type,'image')}">
                                                                            <div><img id="chat_dummy"
                                                                                      src='${pageContext.request.contextPath}/chat/download?chat_no=${chatVo.chat_no}'>
                                                                            </div>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <div><img id="chat_dummy"
                                                                                      src="${pageContext.request.contextPath}/resources/image/filedummy.jpeg">
                                                                            </div>
                                                                        </c:otherwise>
                                ...
                                <div class="chat-send-content">
                                    ...
                                    <div class="chat-send-text">
                                        <input id="dropzone" class="form-control user-input" type="text"
            ...
            <!-- 팀 리스트end -->
            <!-- 팀 초대 -->
            <div class="modal fade" id="inviteTeam" tabindex="-1" role="dialog"
                 aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form class="email-form" action="topic_main" method="post">
                            ...
                            <div class="modal-footer">
                                <button type="button" id="invite_close" class="btn btn-secondary" data-dismiss="modal">
                                    닫기
                                </button>
                                <input type="submit" id="invite-send" class="btn btn-primary invite-send"
                                       value="초대하기"><span></span>
            ...
            <form action="topic_masterchange" method="post">
                <div class="modal fade" id="topicMasterChange" tabindex="-1" role="dialog"
                     aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <span>다음 토픽 관리자를 선택해주세요</span><br>
                                <hr>
                                <input type="hidden" name="topic_no" value="${param.topic_no }">
                                <input type="hidden" name="team_no" value="${param.team_no }">
                                <c:forEach var="tmList" items="${topicMemberList}">
            ...
            <form action="invitetopic" method="post">
                <div class="modal fade" id="inviteTopic" tabindex="-1" role="dialog"
                     aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
