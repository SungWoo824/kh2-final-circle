...
<head>
<meta charset="UTF-8">
<title>소유자 팀관리 / 멤버설정 페이지 / 소유자 보기</title>
</head>
...
<div class="row">
  <div class="col-3">
      ...
      <a class="nav-link active" id="v-pills-messages-tab" data-toggle="pill" href="${pageContext.request.contextPath}/team_admin/member_list_owner?team_no=${teamDto.team_no}&team_name=${teamDto.team_name}&team_domain=${teamDto.team_domain}" role="tab" aria-controls="v-pills-messages" aria-selected="false">소유자</a>
