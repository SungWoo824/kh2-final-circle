...
<!--             <h6 class="collapse-header">Login Screens:</h6> -->
      ...
      <li class="nav-item active">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="${pageContext.request.contextPath}/manager/profit">전체 결제 내역</a>
            <div class="collapse-divider"></div>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid" style="overflow:auto">
	        <article class="admin-wrap" style="padding-top: 7rem; padding-left:2.5rem;">
			     <table class="table table-hover">
					...
					<tbody>
						<c:forEach items="${profitList}" var="profitDto">
							<tr class="table-light">
								<td>${profitDto.partner_user_id}</td>
								<td>${profitDto.approved_time}</td>
								<td>${profitDto.item_name}</td>
								<td>${profitDto.quantity}</td>
								<td>${profitDto.total_amount}</td>	
								<td>${profitDto.status}</td>						
							</tr>
						</c:forEach>
				...
				<ul class="pagination" style="justify-content: center;">
                    ...
                    <c:forEach var="pageNum" begin="${pagination.startPage }" end="${pagination.endPage }">
                        <c:choose>
                            ...
                            <c:otherwise>
	                            <li class="page-item">
							      <a href="${pageContext.request.contextPath}/manager/profit?type=${param.type}&value=${param.value}&curPage=${pageNum}" class="page-link" onClick="fn_paging('${pageNum }')">${pageNum }</a> 
							    </li>
