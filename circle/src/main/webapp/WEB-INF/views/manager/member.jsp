        ...
        <li class="nav-item active">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="${pageContext.request.contextPath}/manager/member?type=&value=">회원
                        목록</a>
                                    ...
                                    <c:if test="${pagination.curPage ne 1}">
                                        <li class="page-item disabled">
                                            <a class="page-link" href="#"
                                               onClick="fn_paging('${pagination.prevPage }')">&laquo;</a>
                                        </li>
                                    </c:if>
                                        ...
                                        <c:choose>
                                            <c:when test="${pageNum eq  pagination.curPage}">
                                                <li class="page-item active">
                                                    <span style="font-weight: bold;"><a class="page-link" href="#"
                                                                                        onClick="fn_paging('${pageNum }')">${pageNum }</a></span>
                                                </li>
                                            </c:when>
                                            <c:otherwise>
                                                <li class="page-item">
                                                    <a href="${pageContext.request.contextPath}/manager/member?type=${param.type}&value=${param.value}&curPage=${pageNum}"
                                                       class="page-link"
                                    ...
                                    <c:if test="${pagination.curPage ne pagination.pageCount && pagination.pageCount > 0}">
                                        <li class="page-item">
                                            <a href="#" class="page-link"
                                               onClick="fn_paging('${pagination.nextPage }')">&raquo;</a>
                                        </li>
                                    </c:if>
                                </ul>
                            </div>
