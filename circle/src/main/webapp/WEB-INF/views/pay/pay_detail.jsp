...
<input type="hidden" name="partner_order_id" value="2">

<input type="hidden" name="price" value="5000">
<input type="hidden" name="term" value="30">
<input type="hidden" name="total_amount" id="total_amount" value=1>
...
<input type="hidden" name="partner_user_id" value="${member_email }">
<input type="hidden" name="partner_order_id" value="3">
